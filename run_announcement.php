...
<label for="tts_filename">Filename must be one word, no spaces or characters (without extension):</label><br>
<input type="text" id="tts_filename" placeholder="e.g., myannounce" style="width: 200px;"><br><br>
...
$(document).ready(function () {
    ...
    // Global Play for MP3/WAV with warning
