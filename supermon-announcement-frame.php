...
if (empty($referer) || 
    ...
    // Not coming from Supermon â†’ deny direct access
    ...
    echo "<p style='text-align:center;'><a href='/supermon/'>â† Go to Supermon Login</a></p>";
...
<body>
    ...
    <div class="container">
        ...
        <?php include 'supermon-announcement-frame.inc'; ?>
